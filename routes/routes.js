...
// a temporary solution to an immediate confirmation of the withdraw transaction
withdrawRoutes.route('/immediate-confirm-transaction').post(withdrawController.immediateConfirm);
